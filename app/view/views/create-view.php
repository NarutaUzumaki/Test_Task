...
<header>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="#">Новая запись</a>
    ...
    <div style="padding: 1%">
        <form method="post" action="/operation/store">
            <div class="form-group row">
                <label class="col-sm-1 col-form-label">Название</label>
                    <div>
                        <input class="form-control" type="text" name="title" placeholder="Назовите запись" required>
                    </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-1 col-form-label">Описание</label>
                    <div>
                        <input class="form-control" type="text" name="description" placeholder="Введите описание" required>
                    </div>
            </div>
            ...
            <div class="form-group row">
                <label class="col-sm-1 col-form-label">Операция</label>
                    <div>
                        <input class="form-control" type="text" name="amount" placeholder="Сумма операции" required>
                    </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-1 col-form-label">Дата</label>
                    <div>
                        <input class="form-control" type="date" name="date" placeholder="Choose date" required>
                    </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-1 col-form-label">Время</label>
                    <div>
                        <input class="form-control" type="time" name="time" placeholder="Choose time" required>
                    </div>
            </div>
            <button class="btn btn-success" type="submit">Создать запись</button>
        </form>
    </div>
</body>